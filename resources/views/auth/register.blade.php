<x-layout>
    ...
    <body class="font-sans antialiased bg-gray-50">
        ...
        <div class="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
            ...
            <div
                class="w-full max-w-lg bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-8 relative z-10 border border-gray-100">
                <a href="{{ route('home') }}"
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-sm text-gray-500 mt-2">
                        Sudah punya akun? <a href="{{ route('login') }}"
                            class="text-brand-blue hover:underline font-medium">Masuk di sini</a>
                    </p>
                </div>
                ...
                <form action="{{ route('register.process') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        <label for="name" class="block text-sm font-semibold text-brand-navy mb-2">Nama
                            Lengkap</label>
                    ...
                    <div>
                        <label for="email" class="block text-sm font-semibold text-brand-navy mb-2">Alamat
                            Email</label>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative" x-data="{ show: false }">
                                ...
                                <button type="button" @click="show = !show"
                                    class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-brand-navy">
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input id="terms" name="terms" type="checkbox"
                                class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-brand-orange/30 accent-brand-orange"
                                required>
                        </div>
                    ...
                    <button type="submit"
                        class="w-full group bg-brand-orange hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-lg shadow-lg shadow-orange-500/30 transition-all duration-300 transform hover:-translate-y-0.5 flex items-center justify-center gap-2">
                        Daftar Sekarang
