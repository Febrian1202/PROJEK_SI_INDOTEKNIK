...
<head>
    ...
    <title>Login - PT. Indoteknik Prima Mekongga</title>
...
<body class="font-sans antialiased bg-gray-50">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
        ...
        <div class="w-full max-w-md bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-8 relative z-10 border border-gray-100">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-sm text-gray-500 mt-2">
                    Belum terdaftar? <a href="/register" class="text-brand-blue hover:underline font-medium">Daftar Disini!</a>
                </p>
            </div>
            ...
            <form action="{{ route('login.process') }}" method="POST" class="space-y-6">
                ...
                <div class="flex items-center justify-between pt-2">
                    <button type="submit" class="group bg-brand-orange hover:bg-orange-600 text-white font-bold py-2.5 px-6 rounded-lg shadow-lg shadow-orange-500/30 transition-all duration-300 transform hover:-translate-y-0.5 flex items-center gap-2">
                        Sign In
