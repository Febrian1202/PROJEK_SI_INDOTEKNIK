<x-layout>
    <x-slot:title>Manajer QC</x-slot:title>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 sticky top-24">
                        ...
                        <div class="relative h-80 bg-gray-200 group overflow-hidden">
                            <img src="{{ asset('assets/img/team/abd-rahman.png') }}"
                                alt="Foto Profil"
                            ...
                            <div class="absolute bottom-4 left-4 text-white">
                                <span
                                    class="bg-brand-orange px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider shadow-sm">Manajer QC</span>
                            </div>
                        </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
                        <h1 class="text-3xl font-bold text-brand-navy mb-2">Abd. Rahman, S.T</h1>
                        <p class="text-gray-500 text-lg">Manajer QC</p>
                        <div class="h-1 w-20 bg-brand-orange rounded-full mt-4"></div>

                        <div class="mt-6 prose text-gray-600 leading-relaxed text-justify">
                            <p>
                                Abd. Rahman, S.T adalah seorang profesional berpengalaman dengan rekam jejak lebih dari 15
                            ...
                            <p class="mt-4">
                                Sebagai Manajer QC PT. Indoteknik Prima Mekongga, beliau bertanggung jawab atas arah
