<x-layout>
    <x-slot:title>Manajer Produksi</x-slot:title>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 sticky top-24">
                        ...
                        <div class="relative h-80 bg-gray-200 group overflow-hidden">
                            <img src="{{ asset('assets/img/team/andri-arianto.png') }}"
                                alt="Foto Profil"
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
                        <h1 class="text-3xl font-bold text-brand-navy mb-2">Andri Arianto</h1>
                        <p class="text-gray-500 text-lg">Manajer Produksi</p>
                        <div class="h-1 w-20 bg-brand-orange rounded-full mt-4"></div>

                        <div class="mt-6 prose text-gray-600 leading-relaxed text-justify">
                            <p>
                                Andri Arianto adalah seorang profesional berpengalaman dengan rekam jejak lebih dari 15
                            ...
                            <p class="mt-4">
                                Sebagai Manajer Produksi PT. Indoteknik Prima Mekongga, beliau bertanggung jawab atas arah
