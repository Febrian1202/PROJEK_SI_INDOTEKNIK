<nav id="main-nav" class="fixed top-0 left-0 w-full z-50 transition-all duration-300 border-b border-transparent"
            ...
            <div class="hidden md:block">
                ...
                @guest
                    <div class="flex items-center gap-4">
                        <a href="{{ route('login') }}"
                            class="text-white font-medium hover:text-brand-orange transition-colors px-3 py-2">
                            Masuk
                        </a>

                        <a href="{{ route('register') }}"
                            class="bg-white text-brand-navy hover:bg-brand-orange hover:text-white font-bold py-2 px-5 rounded-lg shadow-md transition-all duration-300 transform hover:-translate-y-0.5 border border-transparent">
                            Daftar
                        </a>
                    </div>
                @endguest
    ...
    <div x-show="mobileMenuOpen" class="md:hidden bg-brand-navy border-t border-white/10" x-transition>
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            <a href="{{ route('home') }}"
                class="block rounded-md bg-brand-blue px-3 py-2 text-base font-medium text-white">Beranda</a>
            <a href="#"
                class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-brand-orange hover:text-white">Tentang
                Kami</a>
            <a href="#"
                class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-brand-orange hover:text-white">Layanan</a>
            <a href="#"
                class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-brand-orange hover:text-white">Kontak</a>

            @guest
                <div class="border-t border-white/10 my-2 pt-2">
                    <a href="{{ route('login') }}"
                        class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-brand-orange">Masuk</a>
                    <a href="{{ route('register') }}"
                        class="block rounded-md px-3 py-2 text-base font-medium text-brand-orange hover:text-white">Daftar
                        Akun</a>
                </div>
            @endguest
