    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-4 py-3 bg-brand-blue/10 text-brand-blue font-semibold rounded-lg">
            ...
            <div class="p-4 border-t border-gray-100">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="flex w-full items-center gap-3 px-4 py-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors font-medium">
            ...
            <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-3 pl-4 border-l border-gray-200">
                        ...
                        <div class="h-10 w-10 rounded-full bg-brand-blue text-white flex items-center justify-center font-bold text-lg">
