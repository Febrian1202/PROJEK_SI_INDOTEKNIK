            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-aut">
                ...
                @if (Auth::user()->role == 'admin')
                    ...
                    <a href="{{ route('admin.users.index') }}"
                        class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.users.*') ? 'bg-brand-blue/10 text-brand-blue' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} font-semibold rounded-lg transition-colors">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.lamaran.index') }}"
                        class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.lamaran.*') ? 'bg-brand-blue/10 text-brand-blue' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} font-semibold rounded-lg transition-colors">
                    ...
                    <a href="{{ route('admin.dokumen.index') }}"
                        class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.dokumen.*') ? 'bg-brand-blue/10 text-brand-blue' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} font-semibold rounded-lg transition-colors">
                    ...
                    <a href="{{ route('admin.sites.index') }}"
                        class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.sites.*') ? 'bg-brand-blue/10 text-brand-blue' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} font-semibold rounded-lg transition-colors">
                    ...
                    <a href="{{ route('admin.karyawan.index') }}"
                        class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.karyawan.*') ? 'bg-brand-blue/10 text-brand-blue' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} font-semibold rounded-lg transition-colors">
