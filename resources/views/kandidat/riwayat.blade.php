            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col">
                        <span class="text-xl font-bold text-white">Riwayat Lamaran</span>
                        <span class="text-xs text-brand-gray hidden md:block">Pantau status lamaran pekerjaan yang telah Anda kirim</span>
                    </div>
                </div>
