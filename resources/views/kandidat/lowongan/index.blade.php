    ...
    <div class="pt-24 pb-12 min-h-screen bg-gray-50">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-end mb-8 gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-brand-navy">Lowongan Tersedia</h1>
                    <p class="text-gray-500 mt-1">Temukan karir impian Anda di Indoteknik.</p>
                </div>
                
                <div class="relative w-full md:w-72">
                    <input type="text" placeholder="Cari posisi..." class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-brand-orange/50 focus:border-brand-orange shadow-sm transition-all">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($lowongan as $item)
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-brand-blue/30 transition-all duration-300 flex flex-col h-full group">
                        <div class="p-6 flex-1">
                            ...
                            <div class="flex flex-wrap gap-2 mb-4">
                                <span class="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded border border-gray-200 flex items-center">
                                    <svg class="w-3 h-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                                    Penempatan Sesuai Site
                                </span>
                                <span class="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded border border-gray-200">Full Time</span>
                            </div>
                        </div>

                        <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 rounded-b-xl flex justify-between items-center">
                            <span class="text-xs text-gray-400">Diposting {{ $item->created_at->diffForHumans() }}</span>
                            <a href="{{ route('kandidat.lowongan.show', $item->id) }}" class="text-sm font-bold text-brand-orange hover:text-orange-700 flex items-center group-hover:underline">
                                Detail & Lamar
                ...
                @empty
                    <div class="col-span-1 md:col-span-3 py-16 text-center bg-white rounded-2xl border border-dashed border-gray-300">
